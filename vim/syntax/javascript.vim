...
syntax match   javaScriptNumber          /\<-\=\d\+L\=\>\|\<0[xX]\x\+\>\|\<-\=\d\%([eE][+-]\=\d\+\)\=\>/
...
syntax keyword javaScriptType           const let undefined var void yield
syntax keyword javaScriptOperator       debugger delete in instanceof new typeof
syntax keyword javaScriptBoolean        false true
syntax keyword javaScriptNull           null
syntax keyword javaScriptThis           this

"" Statement Keywords
syntax keyword javaScriptConditional    else if
syntax keyword javaScriptRepeat         do for while
syntax keyword javaScriptBranch         break case continue default return switch
syntax keyword javaScriptStatement      catch finally throw try with

" General-purpose constructors
syntax keyword javaScriptGlobalObjects  Array Boolean Date Function Iterator Number Object RegExp String
" Typed array constructors
syntax keyword javaScriptGlobalObjects  ArrayBuffer DataView Float32Array Float64Array Int16Array Int32Array Int8Array Uint16Array Uint32Array Uint8Array Uint8ClampedArray
" Non-constructor functions
syntax keyword javaScriptGlobalObjects  decodeURI decodeURIComponent encodeURI encodeURIComponent eval isFinite isNaN parseFloat parseInt uneval
" Other
syntax keyword javaScriptGlobalObjects  clearInterval clearTimeout console Infinity JSON Math NaN setInterval setTimeout undefined
" Node specific
syntax keyword javaScriptGlobalObjects  __filename __dirname Buffer exports global module process require
...
syntax keyword javaScriptFutureKeys     abstract boolean byte char class double enum extends final float goto implements int interface long native package private protected public short static super synchronized throws transient volatile

"" DOM/HTML/CSS specified things

" DOM Objects
syntax keyword javaScriptGlobalObjects  Attr CDATASection CharacterData Comment DOMImplementation Document DocumentFragment DocumentType Element Entity EntityReference NamedNodeMap Node NodeList Notation ProcessingInstruction Text
...
syntax case ignore
syntax keyword javaScriptHtmlEvents     onabort onblur onchange onclick ondblclick onerror onfocus onkeydown onkeypress onkeyup onload onmousedown onmousemove onmouseout onmouseover onmouseup onreset onresize onscroll onselect onsubmit onunload
...
syntax region  javaScriptBracket   matchgroup=javaScriptBracket transparent start="\[" matchgroup=javaScriptBracketEnd end="\]" contains=@javaScriptAll,javaScriptParensErrB,javaScriptParensErrC,javaScriptBracket,javaScriptParen,javaScriptBlock,@htmlPreproc
syntax region  javaScriptParen     matchgroup=javaScriptParen   transparent start="("  matchgroup=javaScriptParenEnd end=")"  contains=@javaScriptAll,javaScriptParensErrA,javaScriptParensErrC,javaScriptParen,javaScriptBracket,javaScriptBlock,@htmlPreproc
syntax region  javaScriptBlock     matchgroup=javaScriptBlock   transparent start="{"  matchgroup=javaScriptBlockEnd end="}"  contains=@javaScriptAll,javaScriptParensErrA,javaScriptParensErrB,javaScriptParen,javaScriptBracket,javaScriptBlock,@htmlPreproc 
...
if exists("b:javascript_fold")
    ...
    syntax match   javaScriptFuncName       /\<function\>\s*\(\$\|\w\)*\s*/ nextgroup=javaScriptFuncArgs contains=javaScriptFunction skipwhite
    syntax match   javaScriptOpAssign       /=\@<!=/ nextgroup=javaScriptFuncBlock skipwhite skipempty
    syntax region  javaScriptFuncArgs       contained matchgroup=javaScriptArgParen transparent start="(" matchgroup=javaScriptArgParenEnd end=")" contains=javaScriptLineComment,javaScriptComment nextgroup=javaScriptFuncBlock skipwhite skipempty
    syntax region  javaScriptFuncBlock      contained matchgroup=javaScriptFuncBlock transparent start="{" matchgroup=javaScriptFuncBlockEnd end="}" contains=@javaScriptAll,javaScriptParensErrA,javaScriptParensErrB,javaScriptParen,javaScriptBracket,javaScriptBlock fold
else
